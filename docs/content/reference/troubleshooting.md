...
Most of these come down to network reality or how 24h serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

24h rate-limits like any public site. 24h already paces
...
Where a surface is gated, 24h reads a cookie or token you supply
...
`24h`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what 24h actually did
